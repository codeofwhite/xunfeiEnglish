package engteach.api.voicecloud.webapi.demo;
...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String appid = "30fa122e"; //在控制台-我的应用获取
    private static final String apiSecret = "Mzg2ZDdjODJjYWM1MzE5M2ZkM2E0NGJl"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiKey = "96b41233a0974ee46f365d13ef6bea09"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String file = "iseAudio/cn/read_sentence_cn.pcm"; // 中文
